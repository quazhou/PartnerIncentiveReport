...
<a href="admin/Category-updateInput">更新Category</a>
  ...
  <s:iterator value="categories" var="c">
  	...
  	<s:property value="#c.description"/> | <a href="admin/Category-delete?categoryId=<s:property value="#c.id"/>">删除Category</a>
  	 | <a href="admin/Category-updateInput?categoryId=<s:property value="#c.id"/>">更新Category</a>
  </s:iterator>
