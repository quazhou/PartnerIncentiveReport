...
$(document).ready(function(){
 ...
 $("#getMessage").click(function(){
  $.getJSON("data/jsontest!returnMessage.action",function(data){
 ...
 $("#getUserInfo").click(function(){
  $.getJSON("data/jsontest!returnUserInfo.action",function(data){
   //清空显示层中的数据
   $("#message").html("");
   //为显示层添加获取到的数据
 ...
 $("#getList").click(function(){
  $.getJSON("data/jsontest!returnList.action",function(data){
   //清空显示层中的数据
   $("#message").html("");
 ...
 $("#getMap").click(function(){
  $.getJSON("data/jsontest!returnMap.action",function(data){
   //清空显示层中的数据
   $("#message").html("");
   //使用jQuery中的each(data,function(){});函数
   //从data.userInfosList获取UserInfo对象放入value之中
